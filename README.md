...
panel (now in both designers), sort elements, whole-record
create/copy/delete (writer primitives + DSPF designer UI), and the
Center/Fill/colors-attributes/validity-edit-error-message field-panel
helpers - have moved to CHANGELOG.md rather than staying listed here as
limitations.)
