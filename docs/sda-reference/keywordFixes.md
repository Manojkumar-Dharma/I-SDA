...
| [I-121](#i-121) | Cross-level | One declarative rule spec per keyword (constraints, parameters, dependencies, display) | I-40, I-119 | In progress (USRDFN, WINDOW, PULLDOWN slices done) | v0.10.207 |
...
|-------|------|--------|-------|
| 1 | [I-121](#i-121) | In progress | Keyword rule spec (single source of truth). USRDFN slice done (v0.10.205); WINDOW slice done (v0.10.206); PULLDOWN slice done (v0.10.207); remaining record types (SFL/SFLCTL, MNUBAR, message subfile, plain record) still open. Size (estimate): Large - best done one record type at a time. |
...
> **Area:** Cross-level · **Status:** In progress (USRDFN slice done v0.10.205; WINDOW slice done v0.10.206; PULLDOWN slice done v0.10.207) · **Depends on:** I-40, I-119
