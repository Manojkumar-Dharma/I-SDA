...
| **I-60** | Follow-up from I-42: record-level `ENTFLDATR` Apply guard checks SFL's and MNUBAR's whitelists but not USRDFN's - can still be applied to a `USRDFN` record via the General tab (confirmed). | I-42, I-44 | claimed, in progress |
