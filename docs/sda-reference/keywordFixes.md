...
| [I-121](#i-121) | Cross-level | One declarative rule spec per keyword (constraints, parameters, dependencies, display) | I-40, I-119 | In progress (USRDFN, WINDOW done; PULLDOWN slice claimed) | v0.10.206 |
...
|-------|------|--------|-------|
| 1 | [I-121](#i-121) | In progress | Keyword rule spec (single source of truth). USRDFN slice done (v0.10.205); WINDOW slice done (v0.10.206); PULLDOWN slice claimed; remaining record types (SFL/SFLCTL, MNUBAR, message subfile, plain record) still open. Size (estimate): Large - best done one record type at a time. |
...
> **Area:** Cross-level · **Status:** In progress (USRDFN slice done v0.10.205; WINDOW slice done v0.10.206; PULLDOWN slice claimed) · **Depends on:** I-40, I-119
