...
- L1 (the foundation component) is done, and so is L1b. L1a/L1c remain
  independent of each other and of L1b — either can still be picked up
  without waiting on the other.
- L2, L3, and L4 are all done. Only L1a/L1c remain open (independent
  of each other, see above) - everything else in this doc's High and
  Medium priority tiers is finished.
