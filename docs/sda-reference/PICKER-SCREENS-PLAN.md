...
| Task | Component | Screens | Depends on | Status |
| --- | --- | --- | --- | --- |
| **R4** | SFLCTL-specific (Subfile Control menu: General/Display Layout/Subfile Messages) + wire SFLCTL to R1 (all 8) + R3's Subfile Keywords screen | `screens/record-level/subfile-control-sflctl/*` | R1, R3 | in progress |
